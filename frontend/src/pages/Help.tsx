    ...
    <div className="help-content">
      ...
      <section>
        ...
        <ul>
          ...
          <li><strong>Марка авто:</strong> Начните вводить марку - система предложит варианты. Можно ввести свою марку, если её нет в списке.</li>
          <li><strong>Номер авто:</strong> Введите номер автомобиля. Поддерживаются форматы: РФ (А123БВ777), Украина (АА1234БВ), EU/US (ABC1234) и другие.</li>
    ...
    <div className="help-content">
      ...
      <section>
        ...
        <ul>
          ...
          <li>Марка авто поддерживает автодополнение - начните вводить, и система предложит варианты.</li>
          <li>Номер авто проверяется на корректность формата (РФ, Украина, EU/US и другие форматы).</li>
        </ul>
      </section>
