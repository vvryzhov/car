...
Приложение будет доступно на порту 80. Backend работает на порту 3001 внутри Docker сети.
...
Используется SQLite. База данных создается автоматически при первом запуске в файле `passes.db` в директории backend.
